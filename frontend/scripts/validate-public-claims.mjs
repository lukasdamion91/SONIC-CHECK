...
const deployedFiles = [
  "public/index.html",
  "src/App.js",
  "src/components/CommercialLicenseNotice.jsx",
  "src/components/Navbar.jsx",
  "src/components/ProtectedRoute.jsx",
  "src/lib/accessPolicy.mjs",
  "src/lib/productContract.mjs",
  "src/lib/scanProgressPolling.mjs",
  "src/lib/scanResultIntegrity.mjs",
  "src/lib/scanResultPresentation.mjs",
  "src/lib/userActions.mjs",
