...
test("current HARRY records fail closed when capability binding or V34/V36/V37 output is invalid", async () => {
  const source = await readFile(resultPageUrl, "utf8");
  ...
  assert.match(source, /isCurrentCapabilityBoundHarry && !v37\?\.valid/u);
